...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <div class="logo">
            <div class="logo-icon">
                <img src="logo1.png" alt="Kiut" class="logo-img">
            </div>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="progress.php" class="nav-item <?= $current_page === 'progress.php' ? 'active' : '' ?>">
            <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>
...
<?php
$stmt = $pdo->prepare("SELECT setting_value FROM user_settings WHERE user_id = ? AND setting_key = 'alarm_enabled'");
$stmt->execute([$_SESSION['user_id']]);
$alarm_setting = $stmt->fetchColumn();
?>
var ALARM_ENABLED = <?= $alarm_setting === '0' ? 'false' : 'true' ?>;
